...
function Editor() {
  ...
  // -------------------------------
  // SEND EDIT REQUEST (changes endpoint)
  // -------------------------------
  ...
  // -------------------------------
  // PROGRESS BAR LOGIC (same as generate flow)
  // -------------------------------
  useEffect(() => {
    if (!loading) {
      setPhaseIndex(0)
  ...
  // -------------------------------
  // SAVE BUTTON — just confirms current state is persisted
  // (latestCode already saved server-side after each change)
  // -------------------------------
  ...
  // -------------------------------
  // DOWNLOAD BUTTON — download the actual generated HTML
  // -------------------------------
  ...
  // -------------------------------
  // PREVIEW BUTTON — scroll to preview panel
  // -------------------------------
  const handlePreview = () => {
  ...
  // -------------------------------
  // PUBLISH BUTTON — actually deploy via backend
  // -------------------------------
  ...
  // preview width classes based on device
  const previewWidth =
    device === "phone"
      ? "w-[320px]"
      : device === "tablet"
  ...
  // -------------------------------
  // LOADING / ERROR STATES while fetching website
  // -------------------------------
  if (fetchLoading) {
    return (
    ...
    <div className="min-h-screen bg-[#0b1220] text-white">
        ...
        <div className="px-4 sm:px-6 py-3 flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex gap-2 bg-[#0b1020] border border-white/10 p-1.5 rounded-xl">
              <button
                ...
                className={`p-2 rounded-lg transition ${
                  device === "phone" ? "bg-white/15" : "hover:bg-white/10"
                }`}
              >
                <Smartphone size={18} />
              </button>
              ...
              <button
                ...
                className={`p-2 rounded-lg transition ${
                  device === "tablet" ? "bg-white/15" : "hover:bg-white/10"
                }`}
              >
                <TabletIcon size={18} />
              </button>
              ...
              <button
                ...
                className={`p-2 rounded-lg transition ${
                  device === "desktop" ? "bg-white/15" : "hover:bg-white/10"
                }`}
              >
                <LaptopIcon size={18} />
              </button>
          ...
          <div className="flex flex-wrap items-center justify-end gap-2">
            <button
              onClick={handleSave}
              disabled={isSaving}
              className="px-4 py-2 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 transition flex items-center gap-2 text-sm"
            >
              {isSaving ? (
            ...
            <button
              ...
              className="px-4 py-2 rounded-xl bg-blue-600 hover:bg-blue-500 transition flex items-center gap-2 text-sm disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            <button
              ...
              className="px-4 py-2 rounded-xl bg-violet-600 hover:bg-violet-500 transition flex items-center gap-2 text-sm disabled:opacity-60"
            >
              {isDeploying ? (
                <Loader2Icon size={16} className="animate-spin" />
              ) : (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 lg:py-10">
        <div className="grid grid-cols-1 xl:grid-cols-[420px_minmax(0,1fr)] gap-6">
          ...
          <div className="bg-[#111827] border border-white/10 rounded-3xl p-5 sm:p-6 h-fit">
            ...
            >
              ...
              <p className="text-sm text-zinc-400 mb-8">
                Describe the changes you want. genweb.ai focuses on
                    ...
                    <div
                      ...
                      className={`text-sm rounded-xl p-3 ${
                        msg.role === "user"
                          ...
                          : "bg-violet-500/10 text-zinc-300 border border-violet-400/20"
                      }`}
                    >
          ...
          {/* RIGHT PREVIEW PANEL — actual live website */}
          <div
            id="editor-preview-panel"
            className="bg-[#111827] border border-white/10 rounded-3xl p-4 sm:p-5 min-h-[650px] flex flex-col"
          >
            <div className="flex items-center justify-between mb-4">
              <div>
                <h2 className="text-lg font-semibold">Live Preview Area</h2>
                <p className="text-sm text-zinc-400">
                  Device frame changes based on selected view
                </p>
              </div>
              ...
              {website?.deployed && (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="text-xs text-violet-300 hover:text-violet-200 underline truncate max-w-[200px]"
                >
                  {website.deployUrl}
                </a>
              )}
            ...
            <div className="flex-1 flex items-center justify-center overflow-auto rounded-2xl bg-gradient-to-br from-[#0f172a] via-[#111827] to-[#1e1b4b] p-4">
              <div
                className={`${previewWidth} transition-all duration-300 ${
